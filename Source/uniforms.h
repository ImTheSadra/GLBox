...
namespace Pengine::GL {
    ...
    typedef void (APIENTRYP PFN_OF(GLUNIFORM1FV))(GLint location, GLsizei count, GLfloat* data);
    typedef void (APIENTRYP PFN_OF(GLUNIFORM2FV))(GLint location, GLsizei count, GLfloat* data);
    typedef void (APIENTRYP PFN_OF(GLUNIFORM3FV))(GLint location, GLsizei count, GLfloat* data);
    typedef void (APIENTRYP PFN_OF(GLUNIFORM4FV))(GLint location, GLsizei count, GLfloat* data);
    ...
    extern PFN_OF(GLUNIFORM1FV) Uniform1fv;
    extern PFN_OF(GLUNIFORM2FV) Uniform2fv;
    extern PFN_OF(GLUNIFORM3FV) Uniform3fv;
    extern PFN_OF(GLUNIFORM4FV) Uniform4fv;
